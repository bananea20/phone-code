...
def main():
    ...
    img_save_dir =r"D:\data\evaluation_metric\0112-vis-parking-result\gt_video_100\1s_img"
    ts_save_dir = r"D:\data\evaluation_metric\0112-vis-parking-result\gt_video_100\1s_gz"
    ...
    for idx,file in enumerate(test_file):
        ...
        for video in video_list:
            ...
            # img_tmp_dir = os.path.join(img_dir,file_name )
            # 截图
    ...
    # [rename_ts_files(vdio, "FINDCAR") for vdio in vdio_list] # 压缩文件夹
